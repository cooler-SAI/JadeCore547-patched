...
class boss_kilruk_the_wind_reaver : public CreatureScript
{
    public:
        ...
        {
            boss_kilruk_the_wind_reaverAI(Creature* creature) : BossAI(creature, DATA_PARAGONS_OF_THE_KLAXXI_EVENT)
            {
...
class boss_xaril_the_poisoned_mind : public CreatureScript
{
    public:
        ...
        {
            boss_xaril_the_poisoned_mindAI(Creature* creature) : BossAI(creature, DATA_PARAGONS_OF_THE_KLAXXI_EVENT)
            {
                pInstance = creature->GetInstanceScript();
            }
...
class boss_kaztik_the_manipulator : public CreatureScript
{
    public:
        ...
        {
            boss_kaztik_the_manipulatorAI(Creature* creature) : BossAI(creature, DATA_PARAGONS_OF_THE_KLAXXI_EVENT)
            {
                pInstance = creature->GetInstanceScript();
            }
...
class boss_korven_the_prime : public CreatureScript
{
    public:
        ...
        {
            boss_korven_the_primeAI(Creature* creature) : BossAI(creature, DATA_PARAGONS_OF_THE_KLAXXI_EVENT)
            {
                pInstance = creature->GetInstanceScript();
            }
...
class boss_iyyokuk_the_lucid : public CreatureScript
{
    public:
        ...
        {
            boss_iyyokuk_the_lucidAI(Creature* creature) : BossAI(creature, DATA_PARAGONS_OF_THE_KLAXXI_EVENT)
            {
                pInstance = creature->GetInstanceScript();
            }
...
class boss_karoz_the_locust : public CreatureScript
{
    public:
        ...
        {
            boss_karoz_the_locustAI(Creature* creature) : BossAI(creature, DATA_PARAGONS_OF_THE_KLAXXI_EVENT)
            {
                pInstance = creature->GetInstanceScript();
            }
...
class boss_skeer_the_bloodseeker : public CreatureScript
{
    public:
        ...
        {
            boss_skeer_the_bloodseekerAI(Creature* creature) : BossAI(creature, DATA_PARAGONS_OF_THE_KLAXXI_EVENT)
            {
                pInstance = creature->GetInstanceScript();
            }
...
class boss_rikkal_the_dissector : public CreatureScript
{
    public:
        ...
        {
            boss_rikkal_the_dissectorAI(Creature* creature) : BossAI(creature, DATA_PARAGONS_OF_THE_KLAXXI_EVENT)
            {
                pInstance = creature->GetInstanceScript();
            }
...
class boss_hisek_the_swarmkeeper : public CreatureScript
{
    public:
        ...
        {
            boss_hisek_the_swarmkeeperAI(Creature* creature) : BossAI(creature, DATA_PARAGONS_OF_THE_KLAXXI_EVENT)
            {
                pInstance = creature->GetInstanceScript();
            }
